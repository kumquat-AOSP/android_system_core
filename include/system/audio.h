...
// AUDIO_INPUT_CLIENT_ID_BASE provide a means to refer to client IdŽs not
// explicitly defined in the enum audio_input_clients
#define AUDIO_INPUT_CLIENT_ID_BASE AUDIO_INPUT_CLIENT_ID1

// AUDIO_INPUT_CLIENT_ID_BASE provide a means to refer to client IdŽs not explicitly defined
